export class ProfileScoringService {
   ...
   */
  static calculateBuilderTrustScore(builder: any): number {
    let score = 0;
   ...
   */
  static calculateBuilderAiScore(builder: any): number {
    let score = 50;
   ...
   */
  static calculateContractorTrustScore(contractor: any): number {
    let score = 0;
   ...
   */
  static calculateContractorAiScore(contractor: any, skillsCount = 0, categoriesCount = 0): number {
    let score = 40;
